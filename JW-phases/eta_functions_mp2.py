...
class SpinCorrelatorMachine:
    ...
    def get_SDSF_minus(self, get_n_lowest = 35, print_en_diff = False):
        ...
        # magnitudes
        self.points_mag = np.zeros( (get_n_lowest, len(self.k_points)) )
        # energy differences from GS
        ...
        return self.points_mag, self.points_en
    
    def get_minus_results(self, pars):
        ik, k, shape, n_lowest = pars
        # magnitudes
        points_mag = np.zeros( shape )
        # energy differences from GS
    ...
    def merge_results(self, results):
        ...
        points_mag, points_en = results

        self.points_mag += points_mag
        self.points_en += points_en
