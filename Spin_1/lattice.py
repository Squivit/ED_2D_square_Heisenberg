    ...
    def get_representations(self):
        ...
        def get_periodicities(state_int):
            ...
            for w, trans in weight_matrices:
                ...
                assert rolled_state_int == self.map_config_to_int(np.roll(int_to_cfg(state_int), (-trans[0], -trans[1]), axis = (0, 1)))
        ...
        for bosons_on_sites in tqdm(combinations(sites_available, self.magnon_number), total=int(int(binom(self.n * 2, self.magnon_number))), disable=not self.print):
...
if __name__ == "__main__":
    ...
    """
    min_e, gs, b_num = get_gs(nx, ny, U = 0)
    print(f'Ground state energy E_0/J = {round(min_e, 7)}')
    print(f'GS energy per-site: e_0/J = {round(min_e/n, 7)}')
    print(b_num)
    """    
